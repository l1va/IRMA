...
var modelList = [{
    ...
    models: [{
        modelPath: 'fast_food',
        modelTitle: 'Fast Food'
      },
      {
        modelPath: 'gas_station',
        modelTitle: 'Gas Station'
      },
      {
        modelPath: 'house_1',
        modelTitle: 'House 1'
      ...
      {
        modelPath: 'iss',
        modelTitle: 'International Space Station'
      },
      {
        modelPath: 'iss_half',
        modelTitle: 'ISS half'
      ...
      {
        modelPath: 'kitchen_dining',
        modelTitle: 'Kitchen and Dining'
      },
      {
        modelPath: 'office_building',
        modelTitle: 'Office Building'
      },
      {
        modelPath: 'powerplant',
        modelTitle: 'Power Plant'
      },
      {
        modelPath: 'starting_pen',
        modelTitle: 'Starting Pen'
      },
      {
        modelPath: 'willowgarage',
        modelTitle: 'Willow Garage'
      },
      {
        modelPath: 'cafe',
        modelTitle: 'Cafe'
      ...
      {
        modelPath: 'box_target_green',
        modelTitle: 'Box target (green)'
      },
      {
        modelPath: 'box_target_red',
        modelTitle: 'Box target (red)'
      },
      {
        modelPath: 'hoop_red',
        modelTitle: 'Hoop (red)'
      ...
      {
        modelPath: 'control_console',
        modelTitle: 'Control Console'
      }
    ]
  },

  {
    ...
    models: [{
      ...
      {
        modelPath: 'drc_practice_door_4x8',
        modelTitle: '4x8 Doorway'
      },
      {
        modelPath: 'drc_practice_ladder',
        modelTitle: 'Ladder'
      },
      {
        modelPath: 'hinged_door',
        modelTitle: 'Hinged Door'
      },
      {
        modelPath: 'table',
        modelTitle: 'Table'
      ...
      {
        modelPath: 'table_marble',
        modelTitle: 'Table Marble'
      },
      {
        modelPath: 'cafe_table',
        modelTitle: 'Cafe table'
      },

      {
        modelPath: 'drc_practice_ball_valve',
        modelTitle: 'Ball Valve'
      },
      {
      ...
      {
        modelPath: 'door_handle',
        modelTitle: 'Door Handle'
      },
      ...
      {
        modelPath: 'drc_practice_valve_wall',
        modelTitle: 'Wall (Valve)'
      },
      {
      ...
      {
        modelPath: 'grey_wall',
        modelTitle: 'Grey Wall'
      },
      {
        modelPath: 'asphalt_plane',
        modelTitle: 'Asphalt Plane'
      },
      {
        modelPath: 'drc_practice_base_4x8',
        modelTitle: 'Debris base'
      },
      {
        modelPath: 'ground_plane',
        modelTitle: 'Ground Plane'
      },
      {
        modelPath: 'nist_maze_wall_120',
        modelTitle: '120 Maze Wall'
      },
      {
        modelPath: 'nist_maze_wall_240',
        modelTitle: '240 Maze Wall'
      },
      {
      ...
      {
        modelPath: 'nist_simple_ramp_120',
        modelTitle: 'Simple Ramp'
      },
      {
        modelPath: 'nist_stairs_120',
        modelTitle: 'Stairs'
      }
    ]
  },

  {
    ...
    models: [{
      ...
      {
        modelPath: 'plastic_cup',
        modelTitle: 'Plastic Cup'
      }
    ]
  },

  {
    ...
    models: [{
        modelPath: 'robocup09_spl_field',
        modelTitle: '2009 SPL Field'
      },
      {
        modelPath: 'robocup14_spl_field',
        modelTitle: '2014 SPL Field'
      },
      {
        modelPath: 'robocup_3Dsim_field',
        modelTitle: '3D Sim. Field'
      },
      {
        modelPath: 'robocup14_spl_goal',
        modelTitle: 'SPL Goal'
      },
      {
        modelPath: 'robocup_3Dsim_goal',
        modelTitle: '3D Sim. Goal'
      },
      {
        modelPath: 'robocup_spl_ball',
        modelTitle: 'SPL Ball'
      },
      {
        modelPath: 'robocup_3Dsim_ball',
        modelTitle: '3D Sim. Ball'
      }
    ]
  },

  {
    ...
    models: [{
        modelPath: 'frc2016_chevaldefrise',
        modelTitle: 'Cheval de Frise'
      },
      {
        modelPath: 'frc2016_drawbridge',
        modelTitle: 'Draw Bridge'
      },
      {
        modelPath: 'frc2016_field',
        modelTitle: '2016 Field'
      },
      {
        modelPath: 'frc2016_lowbar',
        modelTitle: 'Low Bar'
      },
      {
        modelPath: 'frc2016_moat',
        modelTitle: 'Moat'
      },
      {
        modelPath: 'frc2016_portcullis',
        modelTitle: 'Portcullis'
      },
      {
        modelPath: 'frc2016_ramparts',
        modelTitle: 'Ramparts'
      },
      {
        modelPath: 'frc2016_rockwall',
        modelTitle: 'Rockwall'
      },
      {
        modelPath: 'frc2016_roughterrain',
        modelTitle: 'Rough Terrain'
      },
      {
        modelPath: 'frc2016_sallyport',
        modelTitle: 'Sallyport'
      },
      {
        modelPath: 'frc_field_2015',
        modelTitle: '2015 Field'
      }
    ]
  },

  {
    ...
    models: [{
      ...
      {
        modelPath: 'irobot_hand',
        modelTitle: 'iRobot Hand'
      },
      {
        modelPath: 'pioneer2dx',
        modelTitle: 'Pioneer 2DX'
      },
      {
        modelPath: 'pioneer3at',
        modelTitle: 'Pioneer 3AT'
      },
      {
        modelPath: 'pr2',
        modelTitle: 'PR2'
      ...
      {
        modelPath: 'simple_arm',
        modelTitle: 'Simple Arm'
      },
      {
        modelPath: 'simple_arm_gripper',
        modelTitle: 'Simple Arm and Gripper'
      },
      {
        modelPath: 'simple_gripper',
        modelTitle: 'Simple Gripper'
      },
      {
        modelPath: 'turtlebot',
        modelTitle: 'TurtleBot'
      },
      {
        modelPath: 'youbot',
        modelTitle: 'YouBot'
      ...
      {
        modelPath: 'follower_vehicle',
        modelTitle: 'Follower Vehicle'
      },
      {
        modelPath: 'iris_with_standoffs',
        modelTitle: 'Iris with Standoffs'
      },
      {
      ...
      {
        modelPath: 'mpl_right_arm',
        modelTitle: 'MPL right arm'
      },
      {
        modelPath: 'mpl_right_forearm',
        modelTitle: 'MPL right forearm'
      },
      {
        modelPath: 'parrot_bebop_2',
        modelTitle: 'Parrot Bebop 2'
      },
      {
        modelPath: 'quadrotor',
        modelTitle: 'Quadrotor'
      },
      {
        modelPath: 'submarine',
      ...
      {
        modelPath: 'submarine_buoyant',
        modelTitle: 'Submarine (buoyant)'
      },
      {
        modelPath: 'submarine_sinking',
        modelTitle: 'Submarine (sinking)'
      },
      {
        modelPath: 'warehouse_robot',
        modelTitle: 'Warehouse Robot'
      },
      {
        modelPath: 'zephyr_delta_wing',
        modelTitle: 'Zephyr Delta Wing'
      }
    ]
  },

  {
    ...
    models: [{
      ...
      {
        modelPath: 'stereo_camera',
        modelTitle: 'Stereo Camera'
      },
      {
        modelPath: 'hokuyo',
        modelTitle: 'Hokuyo'
      ...
      {
        modelPath: 'depth_camera',
        modelTitle: 'Depth Camera'
      },
      {
        modelPath: 'gimbal_small_2d',
        modelTitle: 'Gimbal Small 2D'
      },
      {
        modelPath: 'velodyne_hdl32',
        modelTitle: 'Velodyne HDL-32'
      }
    ]
  },

  {
    ...
    models: [{
        modelPath: 'cinder_block',
        modelTitle: 'Cinder Block'
      },
      {
        modelPath: 'cinder_block_2',
        modelTitle: 'Cinder Block 2'
      },
      {
        modelPath: 'cinder_block_wide',
        modelTitle: 'Cinder Block Wide'
      },
      {
        modelPath: 'construction_barrel',
        modelTitle: 'Construction Barrel'
      },
      {
        modelPath: 'construction_cone',
        modelTitle: 'Construction Cone'
      },
      {
      ...
      {
        modelPath: 'drc_practice_block_wall',
        modelTitle: 'Block Wall'
      },
      {
      ...
      {
        modelPath: 'fire_hydrant',
        modelTitle: 'Fire Hydrant'
      },
      {
        modelPath: 'jersey_barrier',
        modelTitle: 'Jersey Barrier'
      },
      {
        modelPath: 'lamp_post',
        modelTitle: 'Lamp Post'
      },
      {
        modelPath: 'mailbox',
        modelTitle: 'Mailbox'
      ...
      {
        modelPath: 'nist_fiducial_barrel',
        modelTitle: 'Fiducial Barrel'
      },
      {
        modelPath: 'speed_limit_sign',
        modelTitle: 'Speed Limit Sign'
      },
      {
        modelPath: 'stop_sign',
        modelTitle: 'Stop Sign'
      },
      {
        modelPath: 'first_2015_trash_can',
        modelTitle: 'Trash Can'
      },
      {
        modelPath: 'person_standing',
        modelTitle: 'Person Standning'
      },
      {
        modelPath: 'person_walking',
        modelTitle: 'Person Walking'
      }
    ]
  },

  {
    ...
    models: [{
        modelPath: 'cordless_drill',
        modelTitle: 'Cordless Drill'
      },
      {
        modelPath: 'fire_hose_long',
        modelTitle: 'Fire Hose'
      },
      {
      ...
      {
        modelPath: 'monkey_wrench',
        modelTitle: 'Monkey Wrench'
      },
      {
        modelPath: 'polaris_ranger_ev',
        modelTitle: 'Polaris Ranger EV'
      },
      {
        modelPath: 'polaris_ranger_xp900',
        modelTitle: 'Polaris Ranger XP900'
      },
      {
      ...
      {
        modelPath: 'utility_cart',
        modelTitle: 'Utility Cart'
      },
      {
        modelPath: 'car_wheel',
        modelTitle: 'Car Wheel'
      },
      {
        modelPath: 'arm_part',
        modelTitle: 'Arm Part'
      ...
      {
        modelPath: 'gear_part',
        modelTitle: 'Gear Part'
      },
      {
        modelPath: 'gasket_part',
        modelTitle: 'Gasket Part'
      },
      {
        modelPath: 'disk_part',
        modelTitle: 'Disk Part'
      },
      {
        modelPath: 'pulley_part',
        modelTitle: 'Pulley Part'
      },
      {
        modelPath: 'piston_rod_part',
        modelTitle: 'Piston Rod Part'
      },
      {
        modelPath: 't_brace_part',
        modelTitle: 'T Brace Part'
      },
      {
        modelPath: 'u_joint_part',
        modelTitle: 'U Joint Part'
      }
    ]
  },

  {
    ...
    models: [{
      ...
      {
        modelPath: 'breakable_test',
        modelTitle: 'Breakable_test'
      },
      {
        modelPath: 'brick_box_3x1x3',
        modelTitle: 'Brick Box 3x1x3'
      },
      {
        modelPath: 'cardboard_box',
        modelTitle: 'Cardboard Box'
      },
      {
        modelPath: 'cube_20k',
        modelTitle: 'Cube 20k'
      ...
      {
        modelPath: 'cricket_ball',
        modelTitle: 'Cricket Ball'
      },
      {
        modelPath: 'marble_1_5cm',
        modelTitle: 'Marble 1.5 cm'
      },
      {
        modelPath: 'metal_peg',
        modelTitle: 'Metal Peg'
      },
      {
        modelPath: 'metal_peg_board',
        modelTitle: 'Metal Peg Board'
      },
      {
        modelPath: 'mars_rover',
        modelTitle: 'Mars Rover'
      },
      {
        modelPath: 'stone_10_2_5_1cm',
        modelTitle: 'Stone 10 x 2.5 x 1 cm'
      },
      {
        modelPath: 'tube_2_25cm',
        modelTitle: 'Tube 2.25 cm'
      },
      {
        modelPath: 'tube_9_5mm',
        modelTitle: 'Tube 9.5 mm'
      },
      {
      ...
      {
        modelPath: 'wood_cube_10cm',
        modelTitle: 'Wood Cube 10 cm'
      },
      {
        modelPath: 'wood_cube_2_5cm',
        modelTitle: 'Wood Cube 2.5 cm'
      },
      {
        modelPath: 'wood_cube_5cm',
        modelTitle: 'Wood Cube 5 cm'
      },
      {
        modelPath: 'wood_cube_7_5cm',
        modelTitle: 'Wood Cube 7.5 cm'
      },
      {
        modelPath: 'wooden_board',
        modelTitle: 'Wooden Board'
      },
      {
        modelPath: 'wooden_case',
        modelTitle: 'Wooden Case'
      },
      {
      ...
      {
        modelPath: 'wooden_peg',
        modelTitle: 'Wooden Peg'
      },
      {
        modelPath: 'wooden_peg_board',
        modelTitle: 'Wooden Peg Board'
      },
      {
        modelPath: 'drc_practice_2x4',
        modelTitle: '2x4 Lumber'
      },
      {
        modelPath: 'drc_practice_2x6',
        modelTitle: '2x6 Lumber'
      },
      {
        modelPath: 'drc_practice_4x4x20',
        modelTitle: '4x4x20 Lumber'
      },
      {
        modelPath: 'drc_practice_4x4x40',
        modelTitle: '4x4x40 Lumber'
      },
      {
        modelPath: 'drc_practice_blue_cylinder',
        modelTitle: 'Blue Cylinder'
      },
      {
        modelPath: 'drc_practice_wood_slats',
        modelTitle: 'Wood Slats'
      },
      {
      ...
      {
        modelPath: 'textured_shapes',
        modelTitle: 'Textured shapes'
      }
    ]
  }
];
...
$(function () {
  ...
  // Toggle items
  $('#view-collisions').buttonMarkup({
    icon: 'false'
  });
  $('#snap-to-grid').buttonMarkup({
    icon: 'false'
  });
  $('#open-tree-when-selected').buttonMarkup({
    icon: 'false'
  });
  $('#view-transparent').buttonMarkup({
    icon: 'false'
  });
  $('#view-wireframe').buttonMarkup({
    icon: 'false'
  });
  $('#view-joints').buttonMarkup({
    icon: 'false'
  });
  $('#view-com').buttonMarkup({
    icon: 'false'
  });
  ...
  $('#upload-files').click(function () {
    globalEmitter.emit('upload_files');
    globalEmitter.emit('closeTabs', false);
  });
...
gzangular.controller('editorTreeControl', ['$scope', function ($scope) {
...
GZ3D.Gui = function (scene) {
  this.emitter = globalEmitter || new EventEmitter2({
  ...
  this.emitter.on('upload_files', function () {
    that.emitter.emit('notification_popup', 'Uploaded Files');
  });
  ...
  this.emitter.on('show_orbit_indicator', function () {
    that.scene.controls.showTargetIndicator = !that.scene.controls.showTargetIndicator;
    if (!that.scene.controls.showTargetIndicator) {
      $('#view-orbit-indicator').buttonMarkup({
        icon: 'false'
      });
  ...
  this.emitter.on('toggle_notifications', function () {
    ...
    if (!that.showNotifications) {
      $('#toggle-notifications').buttonMarkup({
        icon: 'false'
      });
    } else {
      $('#toggle-notifications').buttonMarkup({
